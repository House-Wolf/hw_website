...
import { Shield, Edit, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-[var(--foreground-muted)]">
            View, edit, and moderate all marketplace listings.
          </p>
        </div>
        <Shield className="text-[var(--accent-main)]" size={20} />
      </div>
        ...
        <>
                    ...
                    <td className="py-3 pr-4">
                      <div className="flex flex-col">
                        <span className="text-xs font-semibold text-[var(--foreground)]">
                          {listing.seller.discordDisplayName || listing.seller.discordUsername}
                        </span>
                    ...
                    <td className="py-3 pr-4">
                      <div className="flex gap-2">
                        ...
                        <form action={deleteAction} className="inline">
                          ...
                          <input type="hidden" name="returnTab" value="manage" />
                          <button
                            type="submit"
                            onClick={(e) => {
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-6 pt-4 border-t border-[var(--border-soft)]">
              ...
              <div className="flex gap-2">
                <Link
                  href={`/dashboard/marketplace?tab=manage&page=${currentPage - 1}`}
