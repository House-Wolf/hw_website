    ...
    <div className="min-h-screen bg-linear-to-b from-shadow via-obsidian to-night-deep">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-foreground-muted italic leading-relaxed max-w-3xl mx-auto">
      ...
      <section
        id="three-pillars"
        className="py-20 px-4 bg-linear-to-b from-night-midnight to-obsidian"
      >
          ...
          >
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <CardComponent
                ...
                children={
                  <>
                    <p className="text-foreground-muted leading-relaxed max-w-3xl mx-auto mb-4">
      ...
      <section
        id="resolnare"
        className="py-20 px-4 bg-linear-to-b from-obsidian via-night-deep to-shadow"
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="group bg-linear-to-br from-steel-dark/20 to-obsidian border border-accent-main rounded-lg p-6 hover:border-steel-light hover:shadow-[0_0_30px_rgba(17,78,98,0.3)] transition-all duration-300">
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-12 h-12 bg-linear-to-br from-steel to-steel-light rounded-lg flex items-center justify-center text-2xl font-bold text-foreground group-hover:scale-110 transition-transform duration-300"></div>
                <div>
            ...
            <div className="group bg-linear-to-br from-crimson-dark/20 to-obsidian border border-accent-main rounded-lg p-6 hover:border-steel-light hover:shadow-[0_0_30px_rgba(17,78,98,0.3)] transition-all duration-300">
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-12 h-12 bg-linear-to-br from-crimson to-crimson-light rounded-lg flex items-center justify-center text-2xl font-bold text-foreground group-hover:scale-110 transition-transform duration-300"></div>
                <div>
      ...
      <section
        id="join-house-wolf"
        className="py-20 px-4 bg-linear-to-b from-shadow to-obsidian"
      >
